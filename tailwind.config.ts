        ...
        extend: {
            backgroundImage: {
                ...
                "projects-section-mobile":
                    "url('/images/projects-section-mobile.png')",
                "projects-section-tablet":
                    "url('/images/projects-section-tablet.png')",
                ...
                "testimonial-mobile":
                    "url('/images/testimonial-bg-mobile.png')",
                "testimonial-tablet":
                    "url('/images/testimonial-bg-tablet.png')",
                "testimonial-desktop":
                    "url('/images/testimonial-bg-desktop.png')",
