...
export const TestimonialCard = ({ imageUrl, name, job, desc, isLeft }: TestimonialCardProps) => {
    return (
        <>
            <div className="relative bg-[#222C3A] border-2 border-[#7236DE] rounded-3xl p-9 w-full">
                <div
                    className={cn(
                        "absolute bg-[#2069D6]/40 rounded-3xl -z-10",
                        isLeft &&
