  ...
  return (
    <>
      <div className="relative w-full h-full">
        ...
        <div className="relative bg-[#11161F] border-2 border-[#222C3A] rounded-3xl p-9 w-full h-full z-20">
          <div className="w-full flex items-center gap-x-6 mb-9">
            <div className="relative min-w-[56px] aspect-square bg-[#1161DA] p-[2px] rounded-full overflow-hidden flex items-center justify-center">
            ...
            <div className="flex flex-col gap-y-1">
              <span className="text-light-primary text-xl font-bold">
                {name}
              </span>

              <span className="text-light-primary/50 text-base">{job}</span>
            </div>
          </div>

          <p className="text-light-primary font-normal text-base leading-7 sm:text-lg">
            {desc}
          </p>
        </div>
      </div>
