            ...
            <ul className="hidden lg:flex items-center justify-end gap-x-9">
                ...
                <li>
                    <button
                        ...
                        className="bg-transparent py-2 px-5 text-white font-semibold text-xl border-2 border-[#19D0F0] rounded-lg transition-shadow hover:shadow-[0px_0px_8px_#19D0F0]"
                    >
                        Entre em contato
                    </button>
                </li>
