  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center">
        <h3 className="text-light-primary text-3xl font-bold text-center mb-4 z-10 lg:text-5xl lg:leading-[55px]">
          Quer impulsionar o seu negócio?
        </h3>

        {/* TODO mudar depois */}
        <p className="text-base text-light-primary font-medium leading-6 text-center mb-9 z-10 lg:text-2xl">
