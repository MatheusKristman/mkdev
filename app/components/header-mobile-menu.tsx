      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            ...
            <button className="w-full mt-auto mb-7 bg-transparent py-2 px-5 text-white font-semibold text-xl border-2 border-[#19D0F0] rounded-lg transition-shadow hover:shadow-[0px_0px_8px_#19D0F0]">
              Entre em contato
            </button>
          </motion.div>
        )}
