...
export const HeaderMobileMenu = ({ isAuthed }: HeaderMobileMenuProps) => {
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        className="absolute z-50 w-full h-full top-0 bottom-0 left-0 right-0 lg:hidden bg-gray-primary/90 backdrop-blur px-6 md:px-16 py-4 flex flex-col overflow-y-auto"
                    >
