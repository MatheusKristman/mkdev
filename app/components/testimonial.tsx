...
export const Testimonial = () => {
    return (
        <section className="w-full px-6 md:px-16 lg:container lg:mx-auto">
            <h2 className="text-white text-3xl font-bold text-center mb-12 md:text-4xl">
                O que nossos{" "}
            ...
            <div className="w-full flex flex-col gap-y-9">
                <div className="w-full flex flex-col items-center justify-between gap-9 lg:flex-row">
                    <TestimonialCard
